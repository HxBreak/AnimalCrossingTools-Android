...
package com.hxbreak.animalcrossingtools.view.canvas;
...
public class FastScrollPopup {
    ...
    private IndexedRecyclerView mRecyclerView;
    ...
    public FastScrollPopup(Resources resources, IndexedRecyclerView recyclerView) {
        ...
        setTextSize(ViewUtils.INSTANCE.dp2px(mRes, 32));
        setBackgroundSize(ViewUtils.INSTANCE.dp2px(mRes, 62));
    }
    ...
    public void draw(Canvas canvas) {
        if (isVisible()) {
            ...
            if (mTextVerticalAlignmentMode == 1) {
     ...
     */
    public Rect updateFastScrollerBounds(IndexedRecyclerView recyclerView, int thumbOffsetY) {
