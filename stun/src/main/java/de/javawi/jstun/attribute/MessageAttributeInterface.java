...
public interface MessageAttributeInterface {
    ...
    int DUMMY = 0x0000;
    enum MessageAttributeType {MappedAddress, ResponseAddress, ChangeRequest, SourceAddress, ChangedAddress, Username, Password, MessageIntegrity, ErrorCode, UnknownAttribute, ReflectedFrom, Dummy}
}